...
Servo servoRoll;
Servo servoYaw;   // x-direction
Servo servoPitch; // y-direction
int servoRollPin = 2;
int servoYawPin = 13;
int servoPitchPin = 15;
...
// Motor Control
void setMotor(int xMotor, int yMotor) {
    // TODO: Motor control via joystick
    Serial.printf("Motor command: %d, %d\n", xMotor, yMotor);
    long servoYawOutput   = map(xMotor,-255,255,0,180);
    long servoPitchOutput = map(yMotor,-255,255,0,180);
    Serial.printf("Angle: %d, %d",servoYawOutput, servoPitchOutput);
    servoYaw.write(servoYawOutput);
